<template>
  <div class="wrap">
    <div class="head-row">
      ...
      <router-link to="/projects/submit" class="btn primary">+ Carica nuovo progetto</router-link>
    </div>

    <!-- Banner invio progetto -->
    <div class="submit-cta">
      <div class="submit-cta-text">
        <strong>Hai un nuovo progetto da proporre?</strong>
        <span>Invialo per la revisione: se approvato verrà pubblicato nel marketplace.</span>
      </div>
      <router-link to="/projects/submit" class="btn outline" style="white-space: nowrap; flex-shrink: 0">
        Carica progetto →
      </router-link>
    </div>
...
.submit-cta-text { display: flex; flex-direction: column; gap: 3px; }
.submit-cta-text strong { font-size: 13px; font-weight: 700; }
.submit-cta-text span   { font-family: var(--mono); font-size: 11px; color: var(--muted); }

  ...
  <div class="home">
    ...
    <section class="hero">
      ...
      <div class="hero-inner">
        ...
        <!-- Drone SVG - versione minimal (clean). Easter egg: clicca i 4
             motori in senso orario partendo da NO per un backflip -->
        <div class="hero-visual">
          <svg
            viewBox="0 0 320 320"
            class="drone-svg"
            :class="{ flipping: isFlipping }"
            aria-label="Drone quadcopter"
            role="img"
          >
            <defs>
              <radialGradient id="rg1" cx="50%" cy="50%" r="50%">
                <stop offset="0%" stop-color="#5dff9f" stop-opacity=".18"/>
            ...
            <!-- 4 bracci a X: linee pulite spesse dal centro del body al centro del motore -->
            <g stroke="#5dff9f" stroke-width="6" stroke-linecap="round">
              <line x1="160" y1="160" x2="80"  y2="80"/>
              <line x1="160" y1="160" x2="240" y2="80"/>
              <line x1="160" y1="160" x2="240" y2="240"/>
              <line x1="160" y1="160" x2="80"  y2="240"/>
            </g>

            <!-- body centrale: rettangolo arrotondato sobrio, niente pattern interno -->
            <rect x="132" y="132" width="56" height="56" rx="10"
                  fill="#0d0d14" stroke="#5dff9f" stroke-width="2.5"/>
            <!-- piccolo "led" centrale, uno solo -->
            <circle cx="160" cy="160" r="4" fill="#5dff9f"/>

            <!-- motori: cerchi scuri con bordo verde, perno (pallino) al centro -->
            <g fill="#0d0d14" stroke="#5dff9f" stroke-width="2.5">
              <g class="motor-grp" data-pos="NO" @click="onMotorClick('NO')">
                <circle cx="80" cy="80" r="18"/>
                <circle cx="80" cy="80" r="3" fill="#5dff9f" stroke="none"/>
              </g>
              <g class="motor-grp" data-pos="NE" @click="onMotorClick('NE')">
                <circle cx="240" cy="80" r="18"/>
                <circle cx="240" cy="80" r="3" fill="#5dff9f" stroke="none"/>
              </g>
              <g class="motor-grp" data-pos="SE" @click="onMotorClick('SE')">
                <circle cx="240" cy="240" r="18"/>
                <circle cx="240" cy="240" r="3" fill="#5dff9f" stroke="none"/>
              </g>
              <g class="motor-grp" data-pos="SO" @click="onMotorClick('SO')">
                <circle cx="80" cy="240" r="18"/>
                <circle cx="80" cy="240" r="3" fill="#5dff9f" stroke="none"/>
              </g>
            </g>
...
/* Easter egg: i motori sono cliccabili. Niente cursor:pointer per non
   tradire il segreto. */
.motor-grp {
  user-select: none;
